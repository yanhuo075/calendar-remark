...
function resolveAppleSplashScreens(useAppleSplashScreens) {
...
async function resolvePreset(preset, faviconPreset) {
  ...
  switch (preset) {
    case "minimal":
      return [await import('../presets/minimal.mjs').then((m) => m.minimalPreset), "default"];
    case "minimal-2023":
      return [await import('../presets/minimal-2023.mjs').then((m) => m.minimal2023Preset), "2023"];
    default:
